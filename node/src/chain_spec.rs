use atlas_sphere_runtime::{
    opaque::Block, AccountId, AuraConfig, BalancesConfig, GrandpaConfig, RuntimeGenesisConfig,
...
pub fn development_config() -> Result<ChainSpec, String> {
    ...
    Ok(
        ChainSpec::builder(wasm_binary_unwrap(), Extensions::default())
            .with_name("Atlas Sphere Development")
            .with_id("atlas_sphere_dev")
            .with_chain_type(ChainType::Development)
            .with_protocol_id(DEFAULT_PROTOCOL_ID)
            .with_properties(default_properties())
            .with_genesis_config_patch(atlas_sphere_genesis(initial_authorities, endowed_accounts))
            .build(),
    )
}
